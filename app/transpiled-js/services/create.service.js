...
var CreateService = /** @class */ (function () {
    ...
    CreateService.prototype.addWorkoutCollection = function (workoutCollectionVO) {
        ...
        return this._http.post("http://172.18.2.182:9081/workouttracker/workoutcollection/create", workoutCollectionVO, options).map(this.extractData).do(function (data) { return console.log(JSON.stringify(data)); });
    };
