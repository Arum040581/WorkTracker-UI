...
export class EndwrkoutComponent {
	...
	workoutModel = new WorkoutVo("","",new Date() ,new Date());
	router:Router;
	
    constructor(private wrkCollectionsService: WrkCollectionsService,private activatedRoute: ActivatedRoute,router: Router){
       this.router = router;
    };
